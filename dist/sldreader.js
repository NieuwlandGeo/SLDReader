/* Version: 2.1.0 - September 25, 2026 14:48:42 */
...
function createOlStyle(styleRule, geometryType) {
  const olStyles = OlStyler(styleRule.symbolizers, {
    geometry: {
      type: geometryType
    }
  }, {}, {
...
export { OlStyler, Reader, createOlStyle, createOlStyleFunction, getByPath, getFunction, getLayer, getLayerNames, getStyle, getStyleNames, isGeometryTypeSupported, loadExternalGraphics, registerCustomSymbol, registerFunction, version, warnOnce };
